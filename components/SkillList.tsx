  ...
  return (
    ...
    >
      {skills.map((icon, index) => (
        <div className="flex flex-row ml-1 mr-1 rounded-lg shadow-sm shadow-secondary-100">
          <div className="w-12 h-12 bg-forground-300 rounded-l-lg">
            <img src={icon.image} alt={`${icon.tip} Icon`} />
          </div>
